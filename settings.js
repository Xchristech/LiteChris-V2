...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "lᴜɴɢ-vᴜʜᴏ-ᴍᴅ",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*lᴛᴀᴛe cᴇᴇɴ ʙʏ ᴍᴇ 😆*",
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/qlej9i.png",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/vmyqn5.png",
...
> ɢɪᴛʜᴜʙ : github.com/Xchristech/LiteChris-V2`,
    // add alive msg here 
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "263783063469",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "ᴍʀ lᴜɴɢ",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ lᴜɴɢ vᴜʜᴏ*",
    ...
    DEV: process.env.DEV || "2348069675806",
